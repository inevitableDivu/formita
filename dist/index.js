...
function useFormita(params) {
  ...
  var _useState3 = react.useState(formData),
    form = _useState3[0],
    setForm = _useState3[1];
  var handleChange = react.useCallback(function (target) {
  ...
  var handleOnSubmit = react.useCallback(function (cb, errorCallback, complete) {
    return function () {
      try {
